...
stop_button_recog = CTkButton(add_face_menu, text="Stop", command=lambda: (enablebutton(button5),vid.release() ))
stop_button_recog.grid(row=13, column=0, pady=5)
